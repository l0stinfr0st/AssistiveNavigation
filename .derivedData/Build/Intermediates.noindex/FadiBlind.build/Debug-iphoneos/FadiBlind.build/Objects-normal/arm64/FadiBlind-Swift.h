...
#ifndef FADIBLIND_SWIFT_H
#define FADIBLIND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FadiBlind",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9FadiBlind11AppDelegate")
...
SWIFT_CLASS("_TtC9FadiBlind15LocationService")
...
@interface LocationService (SWIFT_EXTENSION(FadiBlind)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC9FadiBlind13SceneDelegate")
...
SWIFT_CLASS("_TtC9FadiBlind22SpeechDictationService")
@interface SpeechDictationService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9FadiBlind21SpokenFeedbackService")
@interface SpokenFeedbackService : NSObject <AVSpeechSynthesizerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
